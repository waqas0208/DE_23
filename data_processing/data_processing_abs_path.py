...
def create_processed_table(database_path, processed_data, table_name):
    """
...
def data_processing(csv_file_path, database_path, start_date, end_date):
    ...
    create_processed_table(database_path, processed_data, 'processed_data')
...
if __name__ == "__main__":
    # Define file paths
# Define file paths within the container
    base_dir = "/app"
    csv_file_path = "/app/financial_data.csv"
    database_file_path = "/app/financial_data.db"

    # Set up logging
    log_file_path = os.path.join(base_dir, "2_data_processing.log")
